...
<body>
	<div id="particles-js">
		<form class="box" action="{{ route('web_customer_register_submit') }}" method="post">
			@csrf
        <h1>Register Here...</h1>
        ...
        <a href="{{ route('clogin') }}">LOG-IN</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
