	...
	<header class="header1">
		...
		<div class="container-menu-header">
			...
			<div class="wrap_header">
				<!-- Logo -->
				<a href="{{route('c_main')}}" class="logo">
			...
			<div class="row">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<ul class="p-b-54">
							<li class="p-t-4">
								<a href="{{route('designer')}}" class="s-text13 active1">
									Designer Laces
								</a>
							</li>
							...
							<li class="p-t-4">
								<a href="{{route('newitems')}}" class="s-text13">
									New Items
								</a>
							</li>
						</ul>
						...
						<div class="filter-price p-t-22 p-b-50 bo3">
							...
							<div class="flex-sb-m flex-w p-t-16">
								...
								<div class="s-text3 p-t-10 p-b-10">
									Range: <i class="fa fa-inr" aria-hidden="true"></i><span id="value-lower"> 30</span> -  <i class="fa fa-inr" aria-hidden="true"></i><span id="value-upper"> 200</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2" style="height='300px' width='200px'">
								...
								<div class="block2-img wrap-pic-w of-hidden pos-relative ">
									<a href="{{route('product_detail',['id'=>$d->id])}}"><img src="{{url('storage/app/product')}}{{'/'}}{{$d->image}}" height="300px" width="200px" alt="IMG-PRODUCT"></a>
...
<!--===============================================================================================-->
	<script type="text/javascript" src="{{asset('c_assets/vendor/daterangepicker/moment.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('c_assets/vendor/daterangepicker/daterangepicker.js')}}"></script>
<!--===============================================================================================-->
...
<!--===============================================================================================-->
	<script type="text/javascript" src="{{asset('c_assets/vendor/noui/nouislider.min.js')}}"></script>
	<script type="text/javascript">
		/*[ No ui ]
	    ===========================================================*/
